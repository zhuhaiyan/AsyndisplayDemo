...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/JCustomView/JCustomView.framework"
  install_framework "$BUILT_PRODUCTS_DIR/JKit/JKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/JKit-Swift/JKit_Swift.framework"
